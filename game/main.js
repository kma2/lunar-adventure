...
LunarAdventure.game.state.add('SingleSuccess', LunarAdventure.SinglePlayerSuccess);
LunarAdventure.game.state.add('MultiSuccess', LunarAdventure.MultiPlayerSuccess);
